...
- `calculator.test.ts`: unit tests de logica pura en `src/calculator.ts`, incluyendo operaciones basicas y avanzadas.
...
- `app.input.test.tsx`: clicks, teclado, operadores basicos y avanzados, decimales y limites de entrada.
